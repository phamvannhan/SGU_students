<div class="row">
    <div class="col-md-12">
        <div class="pull-right">
            <button type="button" class="btn btn-primary waves-effect m-r-20" data-toggle="modal" {{ !empty($group_email) && $group_email->status === 'sent' ? 'disabled' : null }} data-target="#modal_company_user">
                <i class="material-icons">location_city</i> Doanh nghiệp
            </button>

            <button type="button" class="btn btn-primary waves-effect m-r-20" data-toggle="modal" {{ !empty($group_email) && $group_email->status === 'sent' ? 'disabled' : null }} data-target="#modal_list_user">
