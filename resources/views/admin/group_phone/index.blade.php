...
@section("meta")
    <meta name="linkDatatable" content="{{ route('admin.group_phone.datatable') }}"/>
@endsection
...
@section("content")
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <a href="{!! route("admin.group_phone.create") !!}" class="btn btn-info waves-effect pull-right">
                ...
                <div class="body table-responsive">
                    ...
                    <div>
                        ...
                        <tr>
                            ...
                            <th>{!! trans("admin_group_phone.table.users_count") !!}</th>
...
@section("script")
    ...
    <script type="text/javascript" src="/assets/admin/js/pages/group_phone.index.js?v=1.1"></script>
@endsection