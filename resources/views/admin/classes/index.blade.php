...
@section("meta")
    <meta name="linkDatatable" content="{{ route('admin.classes.datatable') }}"/>
@endsection
...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <a href="{!! route("admin.classes.create") !!}" class="btn btn-info waves-effect pull-right">
                    <i class="material-icons">add</i>
                    <span>{!! trans("button.create") !!}</span>
                </a>
                <h2>
                    {!! trans("admin_classes.list") !!}
                </h2>
            ...
            <div class="body">
                ...
                <table id="datatable" class="table table-bordered table-striped table-hover dataTable" style="width: 100%">
                    <thead>
                    <tr>
                        <th width="40">{!! trans("admin_classes.table.id") !!}</th>
                        <th>{!! trans("admin_classes.table.class_name") !!}</th>
                        <th>{!! trans("admin_classes.table.created_at") !!}</th>
                        <th width="150">{!! trans("admin_classes.table.action") !!}</th>
                    </tr>
                    </thead>
                </table>
            </div>
...
@section("script")
    ...
    <script type="text/javascript" src="/assets/admin/js/pages/class.index.js?v=1.1"></script>
@endsection